...
$sql = "SELECT * FROM certifications_table ORDER BY cert_id DESC";
...
if ($result->num_rows > 0) { //if the number of rows in the array var $result is > 0 then continue
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td>" . $row["cert_abbreviations"] . "</td>";
        echo "<td><a href='../certification/delete_certification.php?id=" . $row['cert_id'] . "' onclick=\"return confirm('Are you sure you want to delete?')\">delete</a></td>";
        echo "</tr>";
    }
    echo "</table>";
