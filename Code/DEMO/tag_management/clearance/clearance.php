...
<div class="uk-container uk-container-xlarge uk-margin">
  ...
  <a href="../index.php">Back</a>
    ...
    <h1>Clearance Type Tags</h1>

    <!-- initialize the database connection -->
    <?php include "../config.php" ?>

    <!-- insert tags into the database table using POST form-->
    <form action="../clearance/clearance.php" method="post">
    ...
    <!-- view the language tag table -->
    <?php include "../clearance/view_clearance.php" ?>

    <!-- insert into the language tag table -->
    <?php include "../clearance/insert_clearance.php" ?>
