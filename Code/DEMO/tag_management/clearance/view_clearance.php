...
$sql = "SELECT * FROM clearanceType_table ORDER BY clear_id DESC";
...
if ($result->num_rows > 0) { //if the number of rows in the array var $result is > 0 then continue
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td>" . $row["clear_abbreviations"] . "</td>";
        echo "<td><a href='../clearance/delete_clearance.php?id=" . $row['clear_id'] . "' onclick=\"return confirm('Are you sure you want to delete?')\">delete</a></td>";
        echo "</tr>";
    }
    echo "</table>";
